...
return sendMsg(msg.chat_id_,msg.id_,"- المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "MATRIX"))
end
end
...
elseif UserID == 769687845 or UserID == 769687845  then  
...
if UserID == 769687845 or UserID == 769687845 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 769687845 or UserID == 769687845 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
if not msg.SudoBase then return "- هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://MATRIX.github.io/GetVersion.txt') or "0"
...
local inline = {{{text="قناه‏‏ السـورس : الـزعـيـم ",url="t.me/MATRIX"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: الـزعـيـم](t.me/MATRIX)',nil,inline,msg.id_)
return false
end
...
echo '*------------------------------\n*- •⊱ { Location } ⊰•\n*»» '`curl http://MATRIX.com/ip/location`'*'
echo '*------------------------------\n*- •⊱ { Server[_]Login } ⊰•\n*»» '`whoami`'*'
echo '*------------------------------\n*- •⊱ { Uptime } ⊰•  \n*»» '"$uptime"'*'
]]):read('*all')
end
...
- BOSS TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
- [Source Channel](https://t.me/MATRIX)

- [Source Install](https://t.me/MATRIX/4121)
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
- [Source Programmer](https://t.me/MATRIX)

- [Twasl Bot Programmer](https://t.me/MATRIXBOT)
...
if not msg.SudoBase then return "- هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://MATRIX.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/MATRIX/MATRIX.github.io/master/plugins/"..FileName)
if res == 200 then
...
NameUser = Hyper_Link_Name(data)
if UserID == 769687845 or UserID == 769687845 then 
...
if FwdUser == 769687845 or FwdUser == 769687845 then 
